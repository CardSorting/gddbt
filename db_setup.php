...
try {
    ...
    // Set up tables based on our migrations
    echo "Creating database tables..." . PHP_EOL;
    
    // Drop existing tables in reverse order to avoid foreign key constraints
    $tables = [
        'user_followers', 'daily_goals', 'user_exercise_completions', 'user_lesson_completions',
        'user_achievements', 'user_progress', 'achievements', 'streaks', 'exercises',
        'lessons', 'skills', 'modules', 'users'
    ];
    ...
    $pdo->exec("CREATE TABLE user_achievements (
        id SERIAL PRIMARY KEY,
        user_id INTEGER NOT NULL,
    ...
    $pdo->exec("CREATE TABLE user_lesson_completions (
        id SERIAL PRIMARY KEY,
        user_id INTEGER NOT NULL,
        lesson_id INTEGER NOT NULL,
    ...
    $pdo->exec("CREATE TABLE user_exercise_completions (
        id SERIAL PRIMARY KEY,
        user_id INTEGER NOT NULL,
    ...
    $pdo->exec("CREATE TABLE daily_goals (
        id SERIAL PRIMARY KEY,
        user_id INTEGER NOT NULL,
        date DATE NOT NULL,
    ...
    $pdo->exec("CREATE TABLE user_followers (
        id SERIAL PRIMARY KEY,
    ...
    // Seed DBT Modules
    $pdo->exec("INSERT INTO modules (name, slug, description, icon, display_order) VALUES 
    ...
    // Seed Skills
    $pdo->exec("INSERT INTO skills (module_id, name, slug, description, display_order) VALUES 
    ...
    // Seed Lessons
    $pdo->exec("INSERT INTO lessons (skill_id, name, slug, description, content, display_order) VALUES 
    ...
    // Seed Exercises
    $pdo->exec("INSERT INTO exercises (lesson_id, name, slug, description, content, exercise_type, display_order) VALUES 
