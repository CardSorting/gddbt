...
class SkillRepository implements SkillRepositoryInterface
{
    ...
    public function all(): array
    {
        try {
            ...
            \Log::error('Error retrieving all skills: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getByModule(int $moduleId, bool $activeOnly = true): array
    {
        try {
            ...
            \Log::error('Error retrieving skills by module: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getWithLessons(int $moduleId, bool $activeOnly = true): array
    {
        try {
            ...
            \Log::error('Error retrieving skills with lessons: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getNextSkill(int $currentSkillId): ?Skill
    {
        try {
            ...
            \Log::error('Error retrieving next skill: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function getSkillsWithPrerequisites(array $skillIds): array
    {
        try {
            ...
            \Log::error('Error retrieving skills with prerequisites: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getSkillsWithUserProgress(int $userId, ?int $moduleId = null): array
    {
        try {
            ...
            \Log::error('Error retrieving skills with user progress: ' . $e->getMessage());
            return [];
        }
    }
}
