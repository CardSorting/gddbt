...
class ExerciseRepository implements ExerciseRepositoryInterface
{
    ...
    public function all(): array
    {
        try {
            ...
            \Log::error('Error retrieving all exercises: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getByLesson(int $lessonId, bool $activeOnly = true): array
    {
        try {
            ...
            \Log::error('Error retrieving exercises by lesson: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getByType(string $type, ?int $lessonId = null): array
    {
        try {
            ...
            \Log::error('Error retrieving exercises by type: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getCompletedByUser(int $userId, ?int $lessonId = null): array
    {
        try {
            ...
            \Log::error('Error retrieving completed exercises: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getWithUserProgress(int $userId, int $lessonId): array
    {
        try {
            ...
            \Log::error('Error retrieving exercises with user progress: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function getByDifficulty(int $difficulty, ?int $limit = null): array
    {
        try {
            ...
            \Log::error('Error retrieving exercises by difficulty: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function recordCompletion(int $userId, int $exerciseId, $answer, bool $isCorrect, int $pointsEarned): bool
    {
        try {
            ...
            \Log::error('Error recording exercise completion: ' . $e->getMessage());
            return false;
        }
    }
}
